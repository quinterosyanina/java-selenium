...
public class EjerciceP9 {
    ...
    public void segundoTest(){
        ...
        //el for y el if de abajo es para mostrar los h2 y el "if"es para que no se vean los h2 vacios.
    ...
    public void fourTest(){
        ...
        //el for y el if de abajo es para mostrar los link y el "if"es para que no se vean los links vacios.
